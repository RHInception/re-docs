...
qthelp:
	...
	@echo "# assistant -collectionFile $(BUILDDIR)/qthelp/redocs.qhc"
...
devhelp:
	...
	@echo "Build finished."
	@echo "To view the help file:"
	@echo "# mkdir -p $$HOME/.local/share/devhelp/redocs"
	@echo "# ln -s $(BUILDDIR)/devhelp $$HOME/.local/share/devhelp/redocs"
	@echo "# devhelp"
